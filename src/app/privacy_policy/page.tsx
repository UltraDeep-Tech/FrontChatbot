...
const page = () => {
  return (
    <div className='w-full h-full flex items-start flex-col px-10 gap-10 justify-center '>
      <div className=' text-redText text-3xl font-bold text-center w-full '> PRIVACY POLICY</div>
      <div className=' text-darkText text-sm text-start whitespace-pre-wrap md:px-20 overflow-auto ' dangerouslySetInnerHTML={{
        __html: `Ultradeep.tech (the “Company”) is committed to maintaining robust privacy protections for its users.  Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we collect, use and safeguard the information you provide to us and to assist you in making informed decisions when using our Service.

        For purposes of this Agreement, “Site” refers to the Company’s website, which can be accessed at https://alex.ultradeep.tech
        “Service” refers to the Company’s services accessed via the Site, in which users can interact with AI avatars.
        ...
        VII.         CONTACT US
        If you have any questions regarding this Privacy Policy or the practices of this Site, please contact us by sending an email to contact@ultradeep.tech.
